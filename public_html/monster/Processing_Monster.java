...
public class Processing_Monster extends PApplet {
...
public void breakBounds(){    // This function will break the bounds of the balls
...
public void reset() {           // This function when called will
  gravity = .1f;          // restore all global variables
  drag = 0.99f;           // to there original settings.
  YBoundTop = 165;       // 
...
class Ball {
  ...
  static public void main(String args[]) {
    PApplet.main(new String[] { "--bgcolor=#F0F0F0", "Processing_Monster" });
  }
}
